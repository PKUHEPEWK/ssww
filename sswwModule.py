...
class sswwProducer(Module):
    def __init__(self,sortkey = lambda x : x.pt,reverse=True,selector=None,maxObjects=None):
    ...
    def analyze(self, event):
        ...
        if not (event.HLT_Mu12_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ or event.HLT_Mu12_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL or event.HLT_Mu17_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL or event.HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL_DZ or event.HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL or event.HLT_Mu23_TrkIsoVVL_Ele8_CaloIdL_TrackIdL_IsoVL_DZ or event.HLT_Mu23_TrkIsoVVL_Ele8_CaloIdL_TrackIdL_IsoVL or event.HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ or event.HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL or event.HLT_Mu8_TrkIsoVVL_Ele17_CaloIdL_TrackIdL_IsoVL or event.HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL or event.HLT_Mu17_TrkIsoVVL_TkMu8_TrkIsoVVL or event.HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ or event.HLT_Mu17_TrkIsoVVL_TkMu8_TrkIsoVVL_DZ or event.HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_DZ or event.HLT_DoubleEle24_22_eta2p1_WPLoose_Gsf or event.HLT_IsoMu20 or event.HLT_IsoMu22 or event.HLT_IsoMu24 or event.HLT_IsoMu27 or event.HLT_IsoTkMu20 or event.HLT_IsoTkMu22 or event.HLT_IsoTkMu24 or event.HLT_IsoTkMu27 or event.HLT_Mu45_eta2p1 or event.HLT_Mu50 or event.HLT_Ele25_eta2p1_WPTight_Gsf or event.HLT_Ele27_eta2p1_WPLoose_Gsf or event.HLT_Ele27_WPTight_Gsf or event.HLT_Ele27_WPTight_Gsf or event.HLT_Ele30_WPTight_Gsf or event.HLT_Ele35_WPLoose_Gsf):
            ...
            '''
            trigger = [event.HLT_Mu12_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ,event.HLT_Mu12_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL,event.HLT_Mu17_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL,event.HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL_DZ,event.HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL,event.HLT_Mu23_TrkIsoVVL_Ele8_CaloIdL_TrackIdL_IsoVL_DZ,event.HLT_Mu23_TrkIsoVVL_Ele8_CaloIdL_TrackIdL_IsoVL,event.HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ,event.HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL,event.HLT_Mu8_TrkIsoVVL_Ele17_CaloIdL_TrackIdL_IsoVL,event.HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL,event.HLT_Mu17_TrkIsoVVL_TkMu8_TrkIsoVVL,event.HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ,event.HLT_Mu17_TrkIsoVVL_TkMu8_TrkIsoVVL_DZ,event.HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_DZ,event.HLT_DoubleEle24_22_eta2p1_WPLoose_Gsf,event.HLT_IsoMu20,event.HLT_IsoMu22,event.HLT_IsoMu24,event.HLT_IsoMu27,event.HLT_IsoTkMu20,event.HLT_IsoTkMu22,event.HLT_IsoTkMu24,event.HLT_IsoTkMu27,event.HLT_Mu45_eta2p1,event.HLT_Mu50,event.HLT_Ele25_eta2p1_WPTight_Gsf,event.HLT_Ele27_eta2p1_WPLoose_Gsf,event.HLT_Ele27_WPTight_Gsf,event.HLT_Ele27_WPTight_Gsf,event.HLT_Ele30_WPTight_Gsf,event.HLT_Ele35_WPLoose_Gsf]
            trigger[0] = event.HLT_Mu12_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ
            trigger[1] = event.HLT_Mu12_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL
            trigger[2] = event.HLT_Mu17_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL
            trigger[3] = event.HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL_DZ
            trigger[4] = event.HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL
            trigger[5] = event.HLT_Mu23_TrkIsoVVL_Ele8_CaloIdL_TrackIdL_IsoVL_DZ
            trigger[6] = event.HLT_Mu23_TrkIsoVVL_Ele8_CaloIdL_TrackIdL_IsoVL
            trigger[7] = event.HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ
            trigger[8] = event.HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL
            trigger[9] = event.HLT_Mu8_TrkIsoVVL_Ele17_CaloIdL_TrackIdL_IsoVL
            trigger[10] = event.HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL
            trigger[11] = event.HLT_Mu17_TrkIsoVVL_TkMu8_TrkIsoVVL
            trigger[12] = event.HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ
            trigger[13] = event.HLT_Mu17_TrkIsoVVL_TkMu8_TrkIsoVVL_DZ
            trigger[14] = event.HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_DZ
            trigger[15] = event.HLT_DoubleEle24_22_eta2p1_WPLoose_Gsf
            trigger[16] = event.HLT_IsoMu20
            trigger[17] = event.HLT_IsoMu22
            trigger[18] = event.HLT_IsoMu24
            trigger[19] = event.HLT_IsoMu27
            trigger[20] = event.HLT_IsoTkMu20
            trigger[21] = event.HLT_IsoTkMu22
            trigger[22] = event.HLT_IsoTkMu24
            trigger[23] = event.HLT_IsoTkMu27
            trigger[24] = event.HLT_Mu45_eta2p1
            trigger[25] = event.HLT_Mu50
            trigger[26] = event.HLT_Ele25_eta2p1_WPTight_Gsf
            trigger[27] = event.HLT_Ele27_eta2p1_WPLoose_Gsf
            trigger[28] = event.HLT_Ele27_WPTight_Gsf
            trigger[29] = event.HLT_Ele27_WPTight_Gsf
            trigger[30] = event.HLT_Ele30_WPTight_Gsf
            trigger[31] = event.HLT_Ele35_WPLoose_Gsf
            '''
